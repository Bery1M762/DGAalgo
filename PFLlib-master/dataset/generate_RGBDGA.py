...
def generate_dataset(dir_path, num_clients, niid, balance, partition, alpha, seed):
    ...
    # 2. 加载数据
    # ==========================================
    raw_file = dir_path + "/dga_rgb_dataset.gz"
    ...
    try:
        ...
        print(f"数据加载完成: X shape={X.shape}, 总数={len(y)}, 类别={num_classes}")
...
if __name__ == "__main__":
    ...
    # 获取当前脚本所在目录的绝对路径 + /RGBDGA
    current_dir = os.path.dirname(os.path.abspath(__file__))
    dir_path = os.path.join(current_dir, "RGBDGA")
